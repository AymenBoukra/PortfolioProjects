select location, 
     ...
     population, 
     total_cases,
	 (total_cases/population)*100 as total_infectionperday
from CovidDeaths
...
order by 1
-----------------------------------------DONE-VIEW----------------------------------------------------
with increment_cases (location,date, total_cases, total_Deaths, Death_percentage)
as(
SELECT location,
     date,
...
----------------------------------------------------------------------------------------------------
create view Deathincrement_perday as
with increment_cases (location,date, total_cases, total_Deaths, Death_percentage)
as(
SELECT location,
     date,
